		...
		<div class="row">
			<div class="container">
				...
				<div class="col-sm-6">
					...
					<p>Whether you choose an existing CMS like WordPress or a custom built interface for managing your content, having the control to modify content on a web site when desired is invaluable to many clients. </p>
				</div>
			</div>
		</div>
	</div>
